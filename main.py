...
class Calc:
    ...
    def __init__(self):
        ...
        self.screen_numbers = Entry(self.window, font="arial 20 bold", bg="#1b3852", fg="white", width=16)
        self.screen_numbers.pack()

        self.frame = Frame(self.window)
        self.frame.pack()

        color_botton_number = "#68700c"
        color_function_number = "#70420c"
        self.button_1 = Button(self.frame, bg=color_botton_number, bd=0, text="1", font="arial 20 bold", fg="white",
                               width=5, height=3, command=lambda: self.touch("1"))

        self.button_2 = Button(self.frame, bg=color_botton_number, bd=0, text="2", font="arial 20 bold", fg="white",
                               width=5, height=3, command=lambda: self.touch("2"))

        self.button_3 = Button(self.frame, bg=color_botton_number, bd=0, text="3", font="arial 20 bold", fg="white",
                               width=5, height=3, command=lambda: self.touch("3"))

        self.button_4 = Button(self.frame, bg=color_botton_number, bd=0, text="4", font="arial 20 bold", fg="white",
                               width=5, height=3, command=lambda: self.touch("4"))

        self.button_5 = Button(self.frame, bg=color_botton_number, bd=0, text="5", font="arial 20 bold", fg="white",
                               width=5, height=3, command=lambda: self.touch("5"))

        self.button_6 = Button(self.frame, bg=color_botton_number, bd=0, text="6", font="arial 20 bold", fg="white",
                               width=5, height=3, command=lambda: self.touch("6"))

        self.button_7 = Button(self.frame, bg=color_botton_number, bd=0, text="7", font="arial 20 bold", fg="white",
                               width=5, height=3, command=lambda: self.touch("7"))

        self.button_8 = Button(self.frame, bg=color_botton_number, bd=0, text="8", font="arial 20 bold", fg="white",
                               width=5, height=3, command=lambda: self.touch("8"))

        self.button_9 = Button(self.frame, bg=color_botton_number, bd=0, text="9", font="arial 20 bold", fg="white",
        ...
        self.button_unincrease = Button(self.frame, bg=color_function_number, bd=0, text="-", font="arial 20 bold",
                                        fg="white", width=5, height=3, command=lambda: self.touch("-"))
